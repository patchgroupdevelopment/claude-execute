...
const SOURCES = [
  ...
  { key: "campTradeVip", id: "-1002971990857", label: "VIP SIGNAL CAMP TRADE", mode: "signal" },
];
...
async function askClaude(system, userText) {
  ...
  try {
    ...
    if (!res.ok) {
      console.log(`Claude API xətası (HTTP ${res.status}):`, JSON.stringify(data).slice(0, 300));
      return null;
    }
